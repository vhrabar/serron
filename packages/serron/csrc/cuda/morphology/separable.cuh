...
/**
 * Window length at which the separable r+c path is preferred over the tiled/GMEM 2-D kernels, for a flat, axis-separable structuring element.
 */
...
/**
 * True when (@p kH, @p kW) and @p kernel_c justify the separable r+c path over the tiled/GMEM 2-D kernels, per @ref separable_min_k.
 */
